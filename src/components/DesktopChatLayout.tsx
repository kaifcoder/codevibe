                  ...
                  <div className="p-2 border-b flex items-center justify-between bg-muted/20">
                    ...
                    <Button
                      ...
                      onClick={async () => {
                        ...
                        try {
                          ...
                          if (data.success) {
                            // Apply the freshly scanned tree — without this the
                            // user clicks refresh, sees the toast, and the tree
                            // never actually updates.
                            if (Array.isArray(data.fileTree)) setFileTree(data.fileTree);
                    ...
                    >
                      <svg
                        ...
                        className={isSyncingFilesystem ? 'animate-spin' : ''}
                      >
