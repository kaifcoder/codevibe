...
CodeVibe is a collaborative AI-powered code editor with real-time synchronization. Users type prompts, an AI agent (GPT-5 via vendor SDK) generates Next.js code in an E2B sandbox, and multiple users can edit simultaneously via Yjs CRDTs.
